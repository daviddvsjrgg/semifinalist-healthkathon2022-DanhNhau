                    ...
                    <div class="card" style="width: 100rem;">
                        <div class="card-body">
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-md-6 mb-4 ">
                                    <div class="form-outline ">
                                        <input placeholder="{{ Auth::user()->nama_id }}" type="text" id="form3Example4"
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-md-6 mb-4 ">
                                    <div class="form-outline ">
                                        <input placeholder="{{ Auth::user()->nik_id }}" type="text" id="form3Example4"
                                            class="form-control" readonly="readonly" />
                                    </div>
                                </div>
                            </div>
                            <h6 class="text-muted mb-4">Tagihan Pembayaran - Rp 600.000 - <a href="#"
